...
{
    public interface IRptExpressionTarget
    {
        #region Methods

        bool GetDefaultProperty(int index, out string propertyName);

        void AssignProperty(string propertyName, IExpression expression);

        IRptExpressionTarget CreateChildTarget(string propertyName);
