...
{
    internal class RptTemplateException : Exception
    {
        #region Constructors

        public RptTemplateException(string message)
            : base(message)
        {
        }

        public RptTemplateException(string message, Exception innerException)
