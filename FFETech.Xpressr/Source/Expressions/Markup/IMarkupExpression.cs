...
{
    public interface IMarkupExpression : IExpression
    {
        #region Properties

        IExpressionDictionary<IExpression> Properties
        {
            get;
        }
        ...
        IExpressionList<IExpression> CreateExpressionList(string propertyName);

        bool GetDefaultProperty(int index, out string name);
