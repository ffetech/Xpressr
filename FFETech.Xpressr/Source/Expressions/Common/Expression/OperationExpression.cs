...
{
    public class OperationExpression : IOperationExpression
    {
        #region Constructors

        public OperationExpression(string name, IExpression binaryOperator, IExpression unaryOperator, IExpression operand)
        {
        ...
        public IExpression BinaryOperator
        {
            get;
            private set;
        }

        public IExpression UnaryOperator
        {
            get;
            private set;
        }
