...
{
    public interface ISqlSelectExpression : IExpression
    {
        #region Properties

        IExpressionList<IExpression> Select
        {
            get;
        }

        IExpressionList<IExpression> From
        {
            get;
        }

        IExpressionList<IOperationExpression> Where
        {
            get;
        }

        IExpressionList<IExpression> GroupBy
        {
            get;
        }

        IExpressionList<IOperationExpression> Having
        {
            get;
        }

        IExpressionList<IExpression> OrderBy
        {
            get;
        }
